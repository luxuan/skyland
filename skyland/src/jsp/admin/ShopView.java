...
public class ShopView{
	...
	public void setAdminNum(int adminNum){this.admin.setNum(adminNum);}
	public int getAdminNum(){return this.admin.getNum();}
	
	public void setRealName(String realName){this.admin.setRealName(realName);}
	...
	public void setAdminName(String adminName){this.admin.setAdminName(adminName);}
	...
	public void setShopName(String shopName){this.shop.setName(shopName);}
	public String getShopName(){return this.shop.getName();}
	
	public void setAddress(String address){this.shop.setAddress(address);}
	...
	public void setDetail(String detail){this.shop.setDetail(detail);}
