...
<table cellpadding="0" cellspacing="0" width="95%">
	<tr>
		...
		<td bgcolor="#8F8F8F" class="td2" id="helpinfo"  style="text-align:left">　添加新文章</td>
...
<html:form  action="/admin/news-update.do?method=add" method="post" >
	<div align="center">
		<table cellpadding="5" cellspacing="0" width="95%" background="images/list_bj.gif" border="0">
			<tr>
				...
				<td><input type="text" name="title" size="50" onFocus="javascript:self.status='帮助：文章标题，必填项，最长200个字符'"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<FCK:editor instanceName="editorContent" width="100%" height="500px">			
