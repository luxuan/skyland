...
<html:form  action="/admin/shopAdd-do.htm?method=add" method="post" enctype="multipart/form-data" >
<div align="center">
...
<table cellpadding="5" cellspacing="0" width="95%" background="images/list_bj.gif" border="0">
	...
	<tr>
		...
		<td><html:text property="shopName" size="30"/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
        ...
        <html:file property="pic" size="30"/>
  　　</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="#FFFFFF"><img src="../imgs/cp_img/yyzz.jpg" width="100" hspace="0" vspace="0" border="0" align="absbottom" >
          <html:file property="license" size="30"/>
　</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><html:text property="qq" size="30"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="#FFFFFF"><html:textarea property="detail" rows="13" cols="64"/></td>
	</tr>
	<tr>
