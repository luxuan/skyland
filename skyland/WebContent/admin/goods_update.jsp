...
<%@ page import="net.fckeditor.FCKeditor,beans.Goods" %>
...
<html:form  action="/admin/goods-update.do?method=update" method="post" enctype="multipart/form-data" >
<logic:present name="adminGoods"  scope="session">
<!-- different from shop_add.jsp -->
<html:hidden name="adminGoods" property="num" />
<!-- different from shop_add.jsp -->
	<div align="center">
...
<table class="add_table" cellpadding="5" cellspacing="0" width="95%" background="images/list_bj.gif" border="0">
	...
	<tr>
		...
		<td>
		<html:select property="categoryNum" name="adminGoods" size="1" >
	...
	<tr bgcolor="#FFFFFF">
        ...
        <html:file property="pic" name="adminGoods" size="20"/>
  　　</td>
	</tr>
	
	<tr>
		<td align="right">商品名称<font color="#FF0000">*</font></td>
		<td><html:text property="name" name="adminGoods" size="30"/></td>
	</tr>
	<tr>
		<td align="right">商品价格<font color="#FF0000">*</font></td>
		<td><html:text property="price" name="adminGoods" size="30"/></td>
	</tr>
	<tr>
		<td align="right">品牌</td>
		<td>
		<html:select property="brandNum" name="adminGoods" size="1" >
	...
	<tr>
		...
		<td><html:text property="specification" name="adminGoods" size="20"/>(可不填)　　</td>
	</tr>
	<tr>
		<td align="right">颜色</td>
		<td><html:text property="colour" name="adminGoods" size="30"/>(可不填)</td>
	</tr>
	<tr>
	  <td align="right">重量</td>
	  <td><html:text property="weight" name="adminGoods" size="20"/>(可不填)</td>
    </tr>
	<tr>
		<td align="right">出品公司</td>
		<td><html:text property="company" name="adminGoods" size="30"/></td>
	</tr>
	<tr>
	  <td align="right">出品日期</td>
	  <td><html:text property="produceTime" name="adminGoods" size="30"/></td>
    </tr>
	<tr>
		<td align="right">　</td>
		<td><html:checkbox value="true" property="isRecommend" name="adminGoods" />是否推荐　　
        	<html:checkbox value="true" property="isBargain" name="adminGoods" />是否特价
            <html:checkbox value="true" property="isHot" name="adminGoods" />是否热销
            <html:checkbox value="true" property="isFresh" name="adminGoods" />是否新鲜</td>
	</tr>
	<tr>
		<td align="right" valign="top" bgcolor="#FFFFFF">详细信息</td>
		<td bgcolor="#FFFFFF">

        <FCK:editor instanceName="detail" value='<%=((Goods)session.getAttribute("adminGoods")).getDetail() %>' width="100%" height="500px">
