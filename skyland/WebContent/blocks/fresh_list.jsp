...
<div class="shop_goods">
    ...
    <logic:present name="freshList" scope="session">
    	<div class="shop_goods_img"><img class="img_left" border="0" hspace="0" vspace="0" src="imgs/images/xpqx.gif" width="674" height="47"></div>
		<logic:iterate id="t" name="freshList" type="jsp.GoodsBargain">  
		    <div class="goods">
		...
		<% session.removeAttribute("freshList"); %>
	</logic:present>
</div>