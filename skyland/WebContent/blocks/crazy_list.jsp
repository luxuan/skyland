...
<div class="shop_goods">
    ...
    <logic:present name="crazyList" scope="session">
	    <div class="shop_goods_img"><img class="img_left" border="0" hspace="0" vspace="0" src="imgs/images/fkqg1.gif" width="674" height="47"></div>
		<logic:iterate id="t" name="crazyList" type="jsp.GoodsBargain">  
		    <div class="goods">
		...
		<% session.removeAttribute("crazyList"); %>
	</logic:present>
    </div>